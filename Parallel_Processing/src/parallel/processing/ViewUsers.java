...
public class ViewUsers extends javax.swing.JFrame {
     ...
     */
    int cardNumber;
    public ViewUsers(int cardNumber) {
        initComponents();
    ...
    private void updateTable(){
        try {
            ...
            ResultSet rs = DBConnection.selectQueryReturnMultipleRows(query);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "User ID", "First Name", "Last Name", "Street", "City", "PhoneNumber"
            }
        ) {
